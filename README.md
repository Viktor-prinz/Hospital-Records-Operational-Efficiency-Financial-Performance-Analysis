...
**Derived column: Age Group.** Patients were banded into 7 groups: infant (less than a year old), Child (1–14), Youth (15-24), Young Adult (25–44), Middle-Aged (45–59), Elderly (60-74) and Senior (75+). Records with null ages are flagged as Unknown.
...
The Power BI dashboard is organized across three pages, each addressing one dimension of the analysis.
...
A total of 1,000 patients were admitted over the three-year period. Female patients accounted for 51.1% of admissions against 48.9% male which is a near-even split. The average patient age at admission was 49 years, with Senior patients (75+) representing the largest single age group at 95 admissions, closely followed by Young Adults (25–44) at 93.
...
*Analysis period: 2021 – 2024 | Dataset: 1000 Patients | 3 years record*
